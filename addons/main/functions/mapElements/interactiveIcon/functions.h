...
#define AIC_fnc_removeInteractiveIconDimensions(_interactiveIconId) missionNamespace setVariable [format ["AIC_Interactive_Icon_%1_Dimensions",(_interactiveIconId)], nil]
